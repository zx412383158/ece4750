...
def fully_used_all_cache_lines_asso( base_addr ):
  return [
    ...
    req( 'rd', 0x2f, 0x000000f4, 0, 0          ), resp('rd', 0x2f, 1, 0,   0xf3334444   ), 
...
test_case_table_set_assoc = mk_test_case_table([
  ...
  [ "fully_used_all_cache_lines_asso",        fully_used_all_cache_lines_asso,  bigdata_preload,       0,    0.0,  0,  0,  0    ],
  ...
  [ "fully_used_all_cache_lines_asso_delay",  fully_used_all_cache_lines_asso,  bigdata_preload,       0,    0.6,  8,  9,  2    ],
...
test_case_table_dir_mapped = mk_test_case_table([
  ...
  [ "fully_used_all_cache_lines_dmap",        fully_used_all_cache_lines_dmap,  bigdata_preload,       0,    0.0,  0,  0,  0    ],
  ...
  [ "fully_used_all_cache_lines_dmap_delay",  fully_used_all_cache_lines_dmap,  bigdata_preload,       0,    0.6,  8,  9,  2    ],
